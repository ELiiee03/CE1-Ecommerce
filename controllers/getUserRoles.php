...
require_once __DIR__ . '/../src/class/userRoles.php'; 
...
try {
    ...
    // Fetch the roles of the user by user_id
    $userRoles = $userRolesObj->getUserRoles($user_id);
    ...
    if ($userRoles) {
        ...
        echo json_encode(['message' => 'User roles not found']);
    }
